...
class RpcListenServerCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'rpc:listen-server';
     ...
     * @var string
     */
    protected $description = 'Run rpc server and listen for incoming rpc calls';
